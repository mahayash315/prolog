...
eval([C|Rest], Weight) :-
    ...
    (eval(Type,Tid,Cid,Val,Weight2), !, Weight is Weight1 + Weight2;
     Weight is Weight1 + 10000).

eval('dependent', Tid, Cid, Dchunk, Weight) :-
...
eval('sequential', Tid, Cid, Pcid, Weight) :-
...
eval('fixed', Tid, Cid, Cell, Weight) :-
...
eval('soft_fixed', Tid, Cid, Cell, Weight) :-
    Cell = cell(Row,Col,_,_),
    cell(Crow,Ccol,Tid,Cid),
    cell_distance(Row,Col,Crow,Ccol,D),
    (0 = D, Weight is 0, !;
